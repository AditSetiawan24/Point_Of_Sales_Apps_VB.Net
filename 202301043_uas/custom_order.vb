...
Public Class custom_order
    ...
    Function hitung_total_per_baris(rowIndex As Integer) As Double
        ...
        If cbb_jenis.SelectedItem = "Figma Figure" Then
            jenis_figure = 700000
        ElseIf cbb_jenis.SelectedItem = "S.H.Figuarts" Then
            jenis_figure = 800000
        ElseIf cbb_jenis.SelectedItem = "Nendoroid" Then
            jenis_figure = 900000
        ElseIf cbb_jenis.SelectedItem = "Petite Chara" Then
            jenis_figure = 1000000
        ElseIf cbb_jenis.SelectedItem = "Mecha" Then
            jenis_figure = 1100000
        Else
            MessageBox.Show("Jenis Figure Tidak Valid")
            Return 0
        End If

        If cbb_bahan.SelectedItem = "ABS" Then
            bahan = 500000
        ElseIf cbb_bahan.SelectedItem = "Vinyl PVC" Then
            bahan = 600000
        ElseIf cbb_bahan.SelectedItem = "Resin" Then
            bahan = 700000
        ElseIf cbb_bahan.SelectedItem = "Metal" Then
            bahan = 800000
        Else
