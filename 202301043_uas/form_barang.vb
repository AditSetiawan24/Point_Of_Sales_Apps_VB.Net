...
Public Class form_barang
    ...
    Sub set_dgv()
        ...
        DataGridView1.Columns(3).HeaderText = "Nama Karakter"
        DataGridView1.Columns(4).HeaderText = "Asal Karakter"
        DataGridView1.Columns(5).HeaderText = "Jenis Figure"
        DataGridView1.Columns(6).HeaderText = "Bahan Figure"
    ...
    Sub edit()
        Try
            ...
            str = "UPDATE tb_barang set id_barang='" & tb_id_bar.Text & "',
                                    ...
                                    nama_karakter='" & tb_kar_bar.Text & "',
                                    asal_karakter='" & cbb_asal_bar.SelectedItem & "',
                                    jenis_figure='" & cbb_jenis_bar.SelectedItem & "',
                                    bahan_figure='" & cbb_bahan_bar.SelectedItem & "',
